...
ComponentAnalyzerTool.docs = {
	...
	sections = {
		{
			heading = "Purpose",
			content = "Identify floating terrain chunks, orphaned pieces, or verify that terrain is properly connected. Essential for polishing terrain before publishing.",
		},
		{
			heading = "Usage",
			bullets = {
				"Select the Component Analyzer tool",
				"Click 'Analyze' to scan terrain",
				"View number of components, sizes, and bounding boxes",
				"Click on a component to highlight it",
				"Use Add or Subtract tools to fix islands",
			},
		},
	},
