...
MegarandomizeTool.category = "Material"
MegarandomizeTool.buttonLabel = "Randomize"

-- ============================================
-- TRAITS
-- ============================================
MegarandomizeTool.traits = {
	category = "Material",
	...
	usesBrush = true,
	usesStrength = true,
	needsMaterial = false, -- Uses palette from config
}
...
-- OPERATION
-- ============================================
function MegarandomizeTool.execute(options: SculptSettings)
	...
	local materials = options.megarandomizeMaterials
		or {
