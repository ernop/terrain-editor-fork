...
SlopePaintTool.category = "Material"
SlopePaintTool.buttonLabel = "Slope Paint"

-- ============================================
-- TRAITS
-- ============================================
SlopePaintTool.traits = {
	category = "Material",
	...
	usesBrush = true,
	usesStrength = true,
	needsMaterial = false, -- Uses multiple materials from config
}
...
-- OPERATION
-- ============================================
function SlopePaintTool.execute(options: SculptSettings)
