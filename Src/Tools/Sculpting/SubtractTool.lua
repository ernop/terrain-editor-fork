...
SubtractTool.category = "Sculpting"
...
function SubtractTool.canUseFastPath(opSet: any): boolean
...
function SubtractTool.fastPath(terrain: Terrain, opSet: any)
	local shape = opSet.brushShape
...
-- OPERATION
-- ============================================
function SubtractTool.execute(options: any)
