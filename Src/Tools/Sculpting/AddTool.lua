...
function AddTool.canUseFastPath(opSet: any): boolean
...
function AddTool.fastPath(terrain: Terrain, opSet: any)
	local shape = opSet.brushShape
...
-- OPERATION
-- ============================================
function AddTool.execute(options: any)
